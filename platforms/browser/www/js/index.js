...
function makeCorsRequest(site_request) {
  // All HTML5 Rocks properties support CORS.
  var url = site_request;
...
function CreateUser(){
	...
	getstuff.open("GET", "php/signup.php?"+requeststring,true);
	getstuff.send();
	uploadprofileImg();
}
var uuuname = "";
...
function is_user(){
    ...
    var responseMessage;
	var requeststring = "http://cookitrite.3eeweb.com/CookItRite/php/login.php";
...
function name_exist(){
 ...
 var responseMessage;
  ...
  xhttp.open("GET", "php/checkuser.php?UserName="+name, true);
  xhttp.send();
	}
...
function getSuggestions(){
	...
	xhttp.open("GET", "php/reccom.php", true);
	xhttp.send();
}
...
function getReccomentations(){
	...
	xhttp.open("POST", "php/reccom.php", true);
	xhttp.send();
...
function uploadprofileImg(){
	...
	xhttp.open("POST", "php/imaged.php", true);
...
getstuff.onreadystatechange=function(){
		...
		var requeststring="php/Create_Recipe.php?q="+JSON.stringify(quanity)+"&qtype="+JSON.stringify(qtype)+"&decrp="+JSON.stringify(descrp)+"&Method="+JSON.stringify(method)+"&Meal_Name="+meal_name+"&image="+imagebase4;
...
function meal_list(){
	var responseMessage;
	var requeststring = "php/view.php";
	var getstuff = new XMLHttpRequest();
	getstuff.onreadystatechange = function(){
        if(getstuff.readyState===4 && getstuff.status===200){
           responseMessage = getstuff.responseText;
...
function show_meal(mealid){
	var responseMessage;
	alert(mealid);
	var requeststring = "php/show_meal.php?Meal_id="+mealid;
	var getstuff = new XMLHttpRequest();
	getstuff.onreadystatechange = function(){
        if(getstuff.readyState===4 && getstuff.status===200){
           responseMessage = getstuff.responseText;
...
function show_meal_details(mealid){
	alert(mealid);
	var responseMessage;
	var requeststring = "php/showmeal_details.php?Meal_id="+mealid;
	var getstuff = new XMLHttpRequest();
	getstuff.onreadystatechange = function(){
        if(getstuff.readyState===4 && getstuff.status===200){
           responseMessage = getstuff.responseText;
         	document.getElementById("row").innerHTML=responseMessage;
        }
	};
	getstuff.open("GET",requeststring ,true);
    getstuff.send();
...
getstuff.onreadystatechange=function(){
		...
		var requeststring="php/kitchen.php?mtype="+mtype+"&meal_name="+meal_name+"&quanity="+q;
		getstuff.open("GET",requeststring,true);
		getstuff.send();
	}
